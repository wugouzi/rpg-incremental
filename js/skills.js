...
const Skills = (() => {
  ...
  const SKILL_TEMPLATES = [
    ...
    // ── 🔥 火焰专精 (pyro) ─────────────────────
    {
      ...
      spec: "pyro",
      type: "active",
      description: "150% ATK + add 2 Burn stacks. Costs 15 MP. CD: 4s",
      effect: { dmgMult: 1.5, burnAdd: 2, cd: 4000, mpCost: 15 },
      requires: "spec_pyro",
      unlockLevel: 15,
      cost: { gold: 300 },
    },
    ...
    },
    {
      ...
      spec: "pyro",
      type: "active",
      description: "250% ATK + add 4 Burn stacks. If target has 5+ stacks, trigger Explosion immediately. Costs 40 MP. CD: 8s",
      effect: { dmgMult: 2.5, burnAdd: 4, explosionThreshold: 5, cd: 8000, mpCost: 40 },
      requires: "ignite",
      unlockLevel: 30,
      cost: { gold: 1200 },
    },
    ...
    },
    {
      ...
      spec: "pyro",
      type: "active",
      description: "For 5s, each hit you receive deals 30% ATK back and adds 1 Burn stack. Costs 25 MP. CD: 18s",
      effect: { heatShieldDuration: 5000, heatShieldReflect: 0.3, cd: 18000, mpCost: 25 },
      requires: "ignite",
      unlockLevel: 22,
      cost: { gold: 600 },
    },
